...
?>
    ...
    <tr>
        ...
        <tr bgcolor="#AAAAFF">
        <td rowspan="5" valign="top"><b>Star Office</b></td>
        <td><a href="http://xml.openoffice.org/">XML</a></td>
        <td>The future-format for StarOffice (open office): XML</td>
        </tr>
        ...
        <tr bgcolor="#CCCCFF">
        <td rowspan="1" valign="top"><b>Corel</b></td>
        ...
        <tr bgcolor="#AAAAFF">
        <td rowspan="2" valign="top"><b>Abiword</b></td>
        <td><a href="http://www.abisource.com/awml.dtd">
            DTD</a></td>
        <td>Fileformat description: DTD</td>
        </tr>
        ...
        <!--
        <tr bgcolor="#CCCCFF">
        <td rowspan="1" valign="top"><b>Lotus</b></td>
    ...
    <p>If you find another interesting one,
    <a href="mailto:koffice@kde.org">please let us know</a>,
    so that we can add it here.</p>
