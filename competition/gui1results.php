<?php
  $page_title="Results of the GUI and Functionality Design Competition for KOffice 2.0";
  $site_root='../';
  include("koffice.inc");
  include("header.inc");
?>
...
<p>The jury has been very pleased to receive a large number of high-quality,
innovative and fun entries. Entries varied from rethinking the entire
work flow for office workers to a careful analysis of the weak points
of the current general practice, with wonderful and weird ideas on the
text-entry process in between. It turns out that it <i>is</i> possible
to find new directions for Office software.</p>
...
seen before in the Adobe applications or on NeXTStep, but not generally
applied to Office software.  Something to be considered for KOffice 2.0!
Not all suggestions were entirely practical or even feasible, but that
was exactly the intention of this competition: to break through the
familiar mold and get fresh ideas.</p>

<p>The decision was quite hard, but in the end the jury was in complete
agreement:</p>

<p>The winner is <b>Martin Pfeiffer</b>, for his thorough and innovative
rethinking of the entire process of creating and working with documents
and tools. <b>Manik Chand Patnaik</b> deserves an honourable mention as
runner-up for his meticulous analysis of the way office software could
work better. <b>Dennis Pennekamp</b> deserves to be mentioned for his
innovative and fun proposal to use Krita and KPresenter together to
...
people whose native language is not English for their courage. They labored under the
additional handicap of a sometimes unfamiliar language and still managed
to present their ideas.</p>

<h4>Entries</h4>

<p>As promised, all entries are available under the GPL. The capsule
reviews below are in many cases not representative of the depth of the ideas
...
document versioning and an interface extensible through plugins that
are grouped into task-related collections. Aiveras' ideas have the advantage
...
truly original rethink of the text entry process we've ever seen. His Freestyle Art
...
that principle, he arrives at an interesting, innovative workflow-based solution that
is both ambitious and takes the human factor into account. The idea of "patterns" to
...
by them. His interface looks very practicable and implementable. The interface
...
combine different types of data in one document. Then he goes one step further and
wants to make it possible to reflow content into another shape: from book to presentation,
from spreadsheet (cells) to document again. A very innovative idea, this, and 
