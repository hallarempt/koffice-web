<?php
  $page_title ='KOffice 2.0 Alpha 6 Release Announcement';
  $site_root = '../';
  include("koffice.inc");
  include("header.inc");
?>
...
<p align="justify">
  ...
  The Alpha 6 release is a work in progress.  This 
...
<p>
Also note that although KOffice developed in close relationship with KDE 4, it has its own
release cycle.
</p>
...
<p align="justify">
      ...
      Another new feature is a much improved infrastructure for OpenDocument, something that is not visible to the user, but very important for the interoperability between KOffice and other office programs.

</p>


<h3>Improvements in Krita</h3>
<p align="justify">

Krita has seen a lot of improvements lately.  Many are of features that existed in version 1.6 and that have now been ported to the new infrastructure of version 2. See the <a href="http://www.koffice.org/announcements/changelog-2.0-alpha6.php">changelog</a> for more details
</p>

<h3>Karbon and KPlato Getting More Mature</h3>
<p align="justify">

      Karbon, the vector drawing application in KOffice, has matured considerably during the last months since the last alpha release.  The changes are too many to enumerate, but one important feature is the ability to edit gradients in a user-friendly way.

</p>

<p align="justify">
      Another application that has matured for KOffice 2 is KPlato, the K Planning Tool. It is a project management application that has seen much development during the last months.  We expect KPlato to make a nice addition to the functionality of KOffice 2 when it is released later this year.
</p>
