...
<p align="justify">May 7, 2008 (The INTERNET).
  The <a href="http://www.kde.org/">KDE Project</a> today announced the
  release of
  <a href="http://www.koffice.org/">KOffice</a> version 2.0 Alpha 7, a technology
...
<p align="justify">
  ...
  The Alpha 7 release is a work in progress.  This 
...
<p align="justify">
    This release is the first to see some results of the OpenDocument Format testsuite being imported into KOffice.  The testsuite exists from a lot of little documents that each show one feature in ODF.  Automated testing of loading those documents will allow developers to keep on workin on the code without fear of breaking the already working code. This is known as regression testing.</br>
    In this release already 23 tests are added into KOffice and the results are visible in much better loading of text documents in KWord.
</p>
