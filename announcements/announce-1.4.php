<?php
  $page_title ='KOffice 1.4 Announcement';
  $site_root = '../';
  include("koffice.inc");
  include("header.inc");
?>
...
<p>New applications in the 1.4 release:</p>
<ul>
...
<p>Improved existing applications:</p>
<ul>
...
<p>
This full set of integrated components makes KOffice one of the most
