<?php
  $page_title ='KOffice 1.5 Beta2 Announcement';
  $site_root = '../';
  include("koffice.inc");
  include("header.inc");
?>
...
<p align="justify">
    <strong>With more than 1500 improvements since the first beta release of the 1.5
    series, the KOffice developers
    invite the user community for another round of testing of KOffice 1.5.</strong></p>

  <p align="justify">March 10, 2006 (The INTERNET).
  The <a href="http://www.kde.org/">KDE Project</a> today announced the
  immediate release of
  <a href="http://www.koffice.org/">KOffice</a> 1.5-beta2, the second beta release for KOffice 1.5,
...
<p align="justify">
  The principal improvements over <a href="http://www.koffice.org/announcements/announce-1.5-beta1.php">KOffice 1.5 beta1</a> are:
</p>
    <strong>General</strong>:
    <ul type="disc">
      <li>
        <div align="justify">
        <strong>OASIS OpenDocument support in KChart, OpenDocument improvements in KWord, KSpread, KPresenter and Karbon
        </strong>:
...
<p>Thanks to strong user testing, Krita received over 500 fixes, and as a result is now much more stable and polished. The Krita developers also worked hard on improving the speed of loading and rendering large and complex images, painting gradients and previewing filter effects. The quality of the raw image input filter has been much improved and Krita is now compliant with the <a href="http://create.freedesktop.org/wiki/index.php/Main_Page">CREATE project</a>.</p>
        </div>
      </li>
      ...
      <li>
        <div align="justify">
        <strong>KPlato user interface, manual and recalculation
        </strong>:

<p>KPlato has been improved beyond recognition through the immense improvement of the recalculation engine. Not only that, but KPlato now has a complete manual and work has continued on improving KPlato's user interface. KPlato is now ready for intensive user testing!</p>
        </div>
      </li>
  ...
  <p />
    ...
    <ul type="disc">
      <li>
        <div align="justify">
         Many improvements in the OpenDocument suppport
        </div>
      </li>
      <li>
        <div align="justify">
         Much improved mouse handling, especially in Text mode
        </div>
      </li>
      <li>
        <div align="justify">
         User interface polish and many bug fixes
        </div>
      </li>
    </ul>
  <p />
    ...
    <ul type="disc">
      <li>
        <div align="justify">
         Improvements to OpenDocument handling
        </div>
      </li>
      <li>
        <div align="justify">
        Object handling now conforms to the KOffice standard
        </div>
      </li>
      <li>
        <div align="justify">
  ...
  <p />
    ...
    <ul type="disc">
      <li>
        <div align="justify">
        Save/load images in the master slide in the OASIS format
        </div>
      </li>
      <li>
        <div align="justify">
    ...
    <ul type="disc">
      <li>
        <div align="justify">Many performance improvements, especially
            in loading rendering images, drawing gradients, rendering
            filter previews.
        </div>
      </li>
      <li>
      ...
      <li>
        <div align="justify">
    	Many fixes and improvements for Adjustment layers. You can actually
        save and load most filters now.
        </div>
      </li>
      <li>
        <div align="justify">
	       Enable scrollwheel and pan in the preview view
        </div>
      </li>
      <li>
        <div align="justify">
