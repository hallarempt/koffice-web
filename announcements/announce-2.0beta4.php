<?php
  $page_title ='KOffice 2.0 Beta 4 Release Announcement';
  $site_root = '../';
  include("koffice.inc");
  include("header.inc");
?>
...
<h2>
  KDE Releases Fourth Beta of KOffice 2.0
</h2>
<p align="justify">December, 2008 (The INTERNET).
  The <a href="http://www.kde.org/">KDE Project</a> today announced the
  release of
  <a href="http://www.koffice.org/">KOffice</a> version 2.0 Beta 4, the fourth
  beta version of the upcoming version 2.0.
</p>

<p align="justify">
    The KOffice team releases a fourth beta version today, in line with the
...
<p align="justify">
    This fourth beta brings significant bug fixes, improved stability,
    improved usability following the discution that have happened at
    the Berlin KOffice Sprint.
    The goal of this beta is to allow testers and users to stay up-to-date
    with the work of the developers and keep providing usefull bug reports.
</p>
<p align="justify">
    ...
    set of improvements and speedups have been integrated for all applications
    and this release shows the continuous  focus on bug fixes
    until 2.0 is released.
</p>
<p align="justify">
    The release team has decided that the following applications are mature
    enough to be part of 2.0 Beta:
    <table border="0">
