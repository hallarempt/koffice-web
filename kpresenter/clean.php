...
?>
    ...
    which are currently implemented in KPresenter. But don't think
    that this is everything which KPresenter can do.</p>
    <b>File:</b> <br />
    ...
    <ul>
      ...
      <li>Pictures in following formats: GIF, JPEG, BMP, XPM, XBM,
      PNM and PNG.</li>
    ...
    <ul>
      ...
      <li>Change text type (normal text, unordered list, enumerated
      list)</li>
