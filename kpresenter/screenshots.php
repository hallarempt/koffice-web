...
$gallery->addImage("pics/kpresenter9_sm.png", "pics/kpresenter5.png", "203", "174", "[Screenshot]", 0 , "Headers and footers");
$gallery->startNewRow();
$gallery->addImage("pics/kpresenter9_sm.png", "pics/kpresenter4.png", "202", "167", "[Screenshot]", 0 , "New effects");
$gallery->addImage("pics/kpresenter9_sm.png", "pics/kpresenter3.png", "191", "173", "[Screenshot]", 0 , "An embedded chart and rotated text");
$gallery->startNewRow();
$gallery->addImage("pics/kpresenter9_sm.png", "pics/kpresenter2.png", "208", "175", "[Screenshot]", 0 , "Presentation structure viewer");
$gallery->addImage("pics/kpresenter9_sm.png", "pics/kpresenter1.png", "189", "169", "[Screenshot]", 0 , "Basic shot");
$gallery->show();
?>
