<?php
  $page_title='KOffice 2.0 Beta 5 Release Notes';
  $site_root='../';
  include("koffice.inc");
  include("header.inc");
?>
<p align="justify">
  DATELINE JANUARY 14, 2009<br />
  ...
  <h2>Announcement</h2>
  <ul>
  <li><a href="/announcements/announce-2.0beta5.php">Announcement</a></li>
  </ul>
    
  <h2>Changelog</h2>
  <ul>
  <li><a href="/announcements/changelog-2.0-beta5.php">Changelog</a></li>
  </ul>
...
-->
  <h2>Download</h2>
  <ul>
    <li>Source code of KOffice 2.0-beta5:
      ...
      <tr>
        ...
        <td><a href="http://download.kde.org/unstable/koffice-1.9.98.4/src/koffice-1.9.98.4.tar.bz2">koffice-1.9.98.4.tar.bz2</a></td>
    </tr>
    <tr>
    <td>KAtelier 2.0-beta-5 (source code, with just Krita and Karbon)</td>
    <td><a href="http://download.kde.org/unstable/koffice-1.9.98.4/src/katelier-1.9.98.4.tar.bz2">katelier-1.9.98.4.tar.bz2</a></td>
    </tr>
    </table>
  </li>
  </ul>
...
<!--<li>
 <a rel="nofollow" href="http://kubuntu.org/">Kubuntu</a>
    <ul type="disc">
      <li>
      <a rel="nofollow" href="http://www.kubuntu.org/news/koffice-2-beta-5">Packages for Intrepid</a>
      </li>
    </ul>
  <p />
</li>-->
