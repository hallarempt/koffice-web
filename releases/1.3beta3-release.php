<?php
  $page_title='KOffice 1.3 beta3 Release Notes';
  $site_root='../';
  include("koffice.inc");
  include("header.inc");
?>
      
      <p>The KOffice team is proud to announce the release of KOffice 1.3 beta3.</p> 
      <p>This release is the last beta in the 1.3 series, bringing
         a lot of bugfixes and a couple of new features (see the complete changelog below).
      </p>
      ...
      <h2>Changelog</h2>
      <ul>
      <li><a href="/announcements/changelog-1.3beta3.php">Changelog</a></li>
      </ul>     
...
<div style="border:thick solid red">
    ...
    <p>KOffice 1.3 Beta 3 has an integer overflow vulnerability in KWord's PDF import filter.</p>
...
<?php
include "md5-koffice-1.2.92.inc"
?>
      <p>
       Also provided: <a href="md5-pgp-koffice-1.2.92.txt">a PGP-signed version of the MD5 sums</a>.
      </p>
