<?php
  $page_title='KOffice 2.0 RC1 Release Notes';
  $site_root='../';
  include("koffice.inc");
  include("header.inc");
?>
<p align="justify">
  DATELINE APRIL 08, 2009<br />
  FOR IMMEDIATE RELEASE
</p>

  <p>The KOffice team is proud to announce the first KOffice Release Candidate for the upcoming 2.0 release.</p>

  <h2>Announcement</h2>
  <ul>
  <li><a href="/announcements/announce-2.0rc1.php">Announcement</a></li>
  </ul>
    
  <h2>Changelog</h2>
  <ul>
  <li><a href="/announcements/changelog-2.0-rc1.php">Changelog</a></li>
  </ul>

<!--
  <h2>Visual changelog</h2>
  <ul>
  <li><a href="/announcements/visual-changelog-2.0-beta4.php">Visual changelog</a></li>
  </ul>
-->
  <h2>Download</h2>
  <ul>
    <li>Source code of KOffice 2.0-rc1:
      <table border="0" cellpadding="5" cellspacing="0">
      <tr>
        <th align="left">Description</th>
        <th align="left">Location</th>
      <tr>
        <td>KOffice 2.0-RC-1 (source code)</td>
        <td><a href="http://download.kde.org/unstable/koffice-1.9.99.0/src/koffice-1.9.99.0.tar.bz2">koffice-1.9.99.0.tar.bz2</a></td>
    </tr>
    <tr>
    <td>KAtelier 2.0-RC-1 (source code, with just Krita and Karbon)</td>
    <td><a href="http://download.kde.org/unstable/koffice-1.9.99.0/src/katelier-1.9.99.0.tar.bz2">katelier-1.9.99.0.tar.bz2</a></td>
    </tr>
    </table>
  </li>
  </ul>
...
<p>
  ...
  KOffice 1.9.99.0 for some versions of their distribution, and in other cases
  community volunteers have done so.
</p>

<p>
  Currently pre-compiled packages are available for (this list is not exhaustive, and is only based on information that was provided to us):
</p>
