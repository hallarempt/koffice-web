<?php
  $page_title='KOffice 1.6.1 Release Notes';
  $site_root='../';
  include("koffice.inc");
  include("header.inc");
?>
<p align="justify">
  ...
  FOR IMMEDIATE RELEASE
      ...
      <p>The KOffice team is proud to announce KOffice 1.6.1.</p>

      <h2>Announcement</h2>
      <ul>
      <li><a href="/announcements/announce-1.6.1.php">Announcement</a></li>
      </ul>

      <h2>Changelog</h2>
      <ul>
      <li><a href="/announcements/changelog-1.6.1.php">Changelog</a></li>
      </ul>

      <h2>Download</h2>
      <ul>
      <li>Source code of KOffice 1.6.1:
	<table border="0" cellpadding="4" cellspacing="0">
	  <tr>
	    <th align="left">Description</th>
	    <th align="left">Location</th>
	  <tr>
	    <td>KOffice 1.6.1 (source code)</td>
	    <td><a href="http://download.kde.org/stable/koffice-1.6.1/src/koffice-1.6.1.tar.bz2">koffice-1.6.1.tar.bz2</a></td>
	  </tr>
	  <tr>
	    <td>KexiMDB 1.1.0 (MS Access import plugin)</td>
	    <td><a href="http://download.kde.org/stable/koffice-1.6.1/src/keximdb-1.1.0.tar.gz">keximdb-1.1.0.tar.gz</a></td>
	  </tr>
	</table>
      </li>
      <li>
	<a href="http://download.kde.org/stable/koffice-1.6.1/">Binary packages</a>, currently available for <a href="http://kubuntu.org/announcements/koffice-161.php">Kubuntu</a> or <a href="http://download.kde.org/stable/koffice-1.6.1/SuSE/">SuSE</a>.
      </li>
<!--      <li>
...
<?php
include "md5-koffice-1.6.1.inc"
?>
      <p>
       Also provided: <a href="md5-pgp-koffice-1.6.1.txt">a PGP-signed version of the MD5 sums</a>.
      </p>

<a name="compiling"></a><h2>
  Compiling KOffice 1.6.1
</h2>
<p align="justify">
  <a name="source_code-library_requirements"></a><strong>Library
  Requirements</strong>:
  KOffice 1.6.1 requires the following libraries:
</p>
<ul>
  <li>
    <div align="justify">
...
<p align="justify">
  ...
  Please note that KOffice 1.6.1 will not
...
<p align="justify">
  ...
  The complete source code for KOffice 1.6.1 is available for free download
  via one of the KDE
  <a href="http://download.kde.org/stable/koffice-1.6.1/">http</a>
