<?php
  $page_title='KOffice 2.0 Alpha 9 Release Notes';
  $site_root='../';
  include("koffice.inc");
  include("header.inc");
?>
<p align="justify">
  DATELINE JULY 15, 2008<br />
  FOR IMMEDIATE RELEASE
</p>

  <p>The KOffice team is proud to announce the ninth KOffice alpha for the upcoming 2.0 release.</p>

  <h2>Announcement</h2>
  <ul>
  <li><a href="/announcements/announce-2.0alpha9.php">Announcement</a></li>
  </ul>
  ...
  <ul>
    ...
    <tr>
    <td>KAtelier 2.0-alpha-9 (source code, with just Krita and Karbon)</td>
...
<p>
  ...
  KOffice 1.95.9 for some versions of their distribution, and in other cases
