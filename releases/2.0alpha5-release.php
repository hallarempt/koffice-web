<?php
  $page_title='KOffice 2.0-alpha5 Release Notes';
  $site_root='../';
  include("koffice.inc");
  include("header.inc");
?>
<p align="justify">
  DATELINE NOVEMBER 21, 2007<br />
  FOR IMMEDIATE RELEASE
</p>

  <p>The KOffice team is proud to announce the fifth KOffice alpha for the upcoming 2.0 release.</p>

  <h2>Announcement</h2>
  <ul>
  <li><a href="/announcements/announce-2.0alpha5.php">Announcement</a></li>
  </ul>

  <h2>Download</h2>
  <ul>
    <li>Source code of KOffice 2.0-alpha-5:
      <table border="0" cellpadding="4" cellspacing="0">
      <tr>
        <th align="left">Description</th>
        <th align="left">Location</th>
      <tr>
        <td>KOffice 2.0-alpha-5 (source code)</td>
        <td><a href="http://download.kde.org/unstable/koffice-1.9.95/src/koffice-1.9.95.tar.bz2">koffice-1.9.95.tar.bz2</a></td>
    </tr>
    <tr>
      <td>diffs between alpha4 and alpha5</td>
...
<li>
 <a href="http://www.mandriva.com/">Mandriva</a>
    <ul type="disc">
      <li>
         2007: <a href="http://download.kde.org/binarydownload.html?url=/unstable/3.95/Mandriva/">Intel i386</a>
      </li>
    </ul>
  <p />
</li -->
