<?php
  $page_title='KOffice 1.4 beta1 Release Notes';
  $site_root='../';
  include("koffice.inc");
  include("header.inc");
?>
...
<?php
include "md5-koffice-1.4-beta1.inc"
?>
      <p>
       Also provided: <a href="md5-pgp-koffice-1.4-beta1.txt">a PGP-signed version of the MD5 sums</a>.
      </p>
