<?php
  $page_title='KOffice 1.3 beta2 Release Notes';
  $site_root='../';
  include("koffice.inc");
  include("header.inc");
?>
      
      <p>The KOffice team is proud to announce the release of KOffice 1.3 beta2.</p> 
      <p>This release is a sequel to the 1st beta in the 1.3 series, bringing
      ...
      <h2>Changelog</h2>
      <ul>
      <li><a href="/announcements/changelog-1.3beta2.php">Changelog</a></li>
      </ul>     
...
<div style="border:thick solid red">
    ...
    <p>KOffice 1.3 Beta 2 has an integer overflow vulnerability in KWord's PDF import filter.</p>
