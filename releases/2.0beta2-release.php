<?php
  $page_title='KOffice 2.0 Beta 2 Release Notes';
  $site_root='../';
  include("koffice.inc");
  include("header.inc");
?>
<p align="justify">
  DATELINE OCTOBER 18, 2008<br />
  FOR IMMEDIATE RELEASE
</p>

  <p>The KOffice team is proud to announce the second KOffice beta for the upcoming 2.0 release.</p>

  <h2>Announcement</h2>
  <ul>
  <li><a href="/announcements/announce-2.0beta2.php">Announcement</a></li>
  </ul>
    
  <h2>Changelog</h2>
  <ul>
  <li><a href="/announcements/changelog-2.0-beta2.php">Changelog</a></li>
  </ul>

<!--
  <h2>Visual changelog</h2>
  <ul>
  <li><a href="/announcements/visual-changelog-2.0-beta2.php">Visual changelog</a></li>
  </ul>
-->
  <h2>Download</h2>
  <ul>
    <li>Source code of KOffice 2.0-beta-2:
      <table border="0" cellpadding="4" cellspacing="0">
      <tr>
        <th align="left">Description</th>
        <th align="left">Location</th>
      <tr>
        <td>KOffice 2.0-beta-2 (source code)</td>
...
<p>
  ...
  KOffice 1.9.98.1 for some versions of their distribution, and in other cases
