<?php
  $page_title='KOffice 1.6.3 Release Notes';
  $site_root='../';
  include("koffice.inc");
  include("header.inc");
?>
<p align="justify">
  DATELINE JUNE 7, 2007<br />
  FOR IMMEDIATE RELEASE
</p>

      <p>The KOffice team is proud to announce KOffice 1.6.3.</p>

      <h2>Announcement</h2>
      <ul>
      <li><a href="/announcements/announce-1.6.3.php">Announcement</a></li>
      </ul>

      <h2>Changelog</h2>
      <ul>
      <li><a href="/announcements/changelog-1.6.3.php">Changelog</a></li>
      </ul>

      <h2>Download</h2>
      <ul>
      <li>Source code of KOffice 1.6.3:
	<table border="0" cellpadding="4" cellspacing="0">
	  <tr>
	    <th align="left">Description</th>
	    <th align="left">Location</th>
	  <tr>
	    <td>KOffice 1.6.3 (source code)</td>
	    <td><a href="http://download.kde.org/stable/koffice-1.6.3/src/koffice-1.6.3.tar.bz2">koffice-1.6.3.tar.bz2</a></td>
	  </tr>
	  <tr>
	    <td>KexiMDB 1.1.0 (MS Access import plugin)</td>
	    <td><a href="http://download.kde.org/stable/koffice-1.6.3/src/keximdb-1.1.0.tar.gz">keximdb-1.1.0.tar.gz</a></td>
	  </tr>
	</table>
      </li>
      </ul>
    ...
    <a href="http://download.fedora.redhat.com/pub/fedora/linux/extras/6/i386/repoview/koffice-core.html">Fedora</a> and
    also for <a href="http://software.opensuse.org/download/KDE:/">Backports/OpenSUSE</a>.
    </li>
...
<?php
include "md5-koffice-1.6.3.inc"
?>
<!--      <p>
       Also provided: <a href="md5-pgp-koffice-1.6.3.txt">a PGP-signed version of the MD5 sums</a>.
      </p>-->

<a name="compiling"></a><h2>
  Compiling KOffice 1.6.3
</h2>
<p align="justify">
  <a name="source_code-library_requirements"></a><strong>Library
  Requirements</strong>:
  KOffice 1.6.3 requires the following libraries:
</p>
<ul>
  <li>
    <div align="justify">
  ...
  <li>
    ...
    spaces.  1.14 should not be used due to severe bugs. 1.16 is the recommended version.
    </div>
  </li>
</ul>
<p align="justify">
  <strong>Compiler Requirements</strong>:
  Please note that KOffice 1.6.3 will not
...
<p align="justify">
  ...
  The complete source code for KOffice 1.6.3 is available for free download
  via one of the KDE
  <a href="http://download.kde.org/stable/koffice-1.6.3/">http</a>
