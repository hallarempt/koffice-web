<?php
  $page_title='KOffice 2.0 Alpha 10 Release Notes';
  $site_root='../';
  include("koffice.inc");
  include("header.inc");
?>
<p align="justify">
  ...
  <p>The KOffice team is proud to announce the tenth KOffice alpha for the upcoming 2.0 release.</p>

  <h2>Announcement</h2>
  <ul>
  <li><a href="/announcements/announce-2.0alpha10.php">Announcement</a></li>
  </ul>
    
  <h2>Changelog</h2>
  <ul>
  <li><a href="/announcements/changelog-2.0-alpha10.php">Changelog</a></li>
  </ul>

  <h2>Visual changelog</h2>
  <ul>
  <li><a href="/announcements/visual-changelog-2.0-alpha10.php">Visual changelog</a></li>
  </ul>

  <h2>Download</h2>
  <ul>
    <li>Source code of KOffice 2.0-alpha-10:
      <table border="0" cellpadding="4" cellspacing="0">
      <tr>
        <th align="left">Description</th>
        <th align="left">Location</th>
      <tr>
        <td>KOffice 2.0-alpha-10 (source code)</td>
        <td><a href="http://download.kde.org/unstable/koffice-1.9.95.10/src/koffice-1.9.95.10.tar.bz2">koffice-1.9.95.10.tar.bz2</a></td>
    </tr>
    <tr>
    <td>KAtelier 2.0-alpha-10 (source code, with just Krita and Karbon)</td>
    <td><a href="http://download.kde.org/unstable/koffice-1.9.95.10/src/katelier-1.9.95.10.tar.bz2">katelier-1.9.95.10.tar.bz2</a></td>
    </tr>
    </table>
  </li>
  </ul>
...
<li>
 <a href="http://kubuntu.org/">Kubuntu</a>
    <ul type="disc">
      <li>
      <a href="http://kubuntu.org/announcements/koffice-2alpha10.php">Packages for 7.10 (Hardy)</a>
      </li>
    </ul>
  <p />
</li>
