<?php
  $page_title='KOffice 2.0 Beta 1 Release Notes';
  $site_root='../';
  include("koffice.inc");
  include("header.inc");
?>
<p align="justify">
  ...
  <p>The KOffice team is proud to announce the first KOffice beta for the upcoming 2.0 release.</p>

  <h2>Announcement</h2>
  <ul>
  <li><a href="/announcements/announce-2.0beta1.php">Announcement</a></li>
  </ul>
...
<p>
  ...
  KOffice 1.9.98 for some versions of their distribution, and in other cases
