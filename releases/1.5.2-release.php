<?php
  $page_title='Press Release: KOffice Version 1.5.2';
  $site_root='../';
  include("koffice.inc");
  include("header.inc");
?>
...
<p align="justify">
 ...
 <p>
 The KOffice team is pleased to announce KOffice version 1.5.2. This is mainly a bugfix release
but also contains numerous translation updates. Especially KWord, KSpread and Kexi have
received critical bug fixes.
 </p>
 ...
 <h3>Announcement</h3>
 <ul>
  <li>The full <a href="/announcements/announce-1.5.2.php">Announcement</a>
      contains much more detailed information about news in KOffice 1.5.2</li>
 </ul>

 <h3>Changelog</h3>
 <ul>
  <li>The <a href="/announcements/changelog-1.5.2.php">Changelog</a>
      contains <b>all</b> the gory details that anybody would ever want.</li>
 </ul>

 <h3>Download</h3>
 <ul>
  <li>The <a href="1.5.2-download.php">Download</a>
      page contains information about downloading KOffice 1.5.2 in source
      and binary formats.
  </li>
 </ul>
...
<p align="justify">
  KOffice 1.5.2 is a subproject within KDE, a powerful and easy-to-use Internet-enabled
