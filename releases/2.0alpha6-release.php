<?php
  $page_title='KOffice 2.0 Alpha 6 Release Notes';
  $site_root='../';
  include("koffice.inc");
  include("header.inc");
?>
<p align="justify">
  DATELINE FEBRUARY 20, 2008<br />
  FOR IMMEDIATE RELEASE
</p>

  <p>The KOffice team is proud to announce the sixth KOffice alpha for the upcoming 2.0 release.</p>

  <h2>Announcement</h2>
  <ul>
  <li><a href="/announcements/announce-2.0alpha6.php">Announcement</a></li>
  </ul>

  <h2>Changelog</h2>
  <ul>
  <li><a href="/announcements/changelog-2.0-alpha6.php">Changelog</a></li>
  </ul>

  <h2>Download</h2>
  <ul>
    <li>Source code of KOffice 2.0-alpha-6:
