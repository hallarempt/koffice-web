<?php
  $page_title='Press Release: KOffice Version 1.5.1';
  $site_root='../';
  include("koffice.inc");
  include("header.inc");
?>
...
inadvisable at the moment if you depend on Kexi: we will release 1.5.2 with a fix next month.
 ...
 <h3>Changelog</h3>
 <ul>
  <li>The <a href="/announcements/changelog-1.5.1.php">Changelog</a>
...
<p align="justify">
  KOffice 1.5.1 is a subproject within KDE, a powerful and easy-to-use Internet-enabled
