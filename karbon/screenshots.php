...
$gallery->addImage("pics/insert_knotsthumb.png", "pics/inset_knots.png", "203", "200", "[Screenshot]", 0 , "Insertion of extra nodes while keeping the overall shape of the path");
$gallery->startNewRow();
